...
<script>
//引入接口
import { regist, login } from "@/service/index.js";
...
.login {
  ...
  left: 0;
  z-index: 2;
  background: url("http://localhost:3000/public/img/loginBg.webp") no-repeat
    center center;
  ...
  form {
    ...
    div .el-input {
      margin-bottom: 30px;
      background-color: rgba($color: #66bcee, $alpha: 0.2);
    }
    .current {
      display: block;
    }
